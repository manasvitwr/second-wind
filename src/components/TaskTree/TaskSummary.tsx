    ...
    return (
      <div ref={ref} className="absolute left-0 top-full mt-3 z-50">
        <div className="relative">
          ...
          />
          <div className="bg-neutral-950 border border-neutral-800 rounded-xl px-6 py-5">
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{
            ...
            borderBottom: '7px solid #0a0a0a',
          }}
        />

        <div className="bg-neutral-950 border border-neutral-800 rounded-xl p-2 flex items-center justify-center">
